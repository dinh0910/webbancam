...
namespace webbancam.Areas.Admin.Controllers
{
    ...
    public class HinhAnhsController : Controller
    {
        ...
        public HinhAnhsController(webbancamContext context)
        {
            _context = context;
        }
        ...
        {
            var webbancamContext = _context.HinhAnh.Include(h => h.SanPham);
        ...
        public async Task<IActionResult> Create([Bind("HinhAnhID,SanPhamID,Ten,Active")] HinhAnh hinhAnh)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("HinhAnhID,SanPhamID,Ten,Active")] HinhAnh hinhAnh)
        {
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'webbancamContext.HinhAnh'  is null.");
            }
            var hinhAnh = await _context.HinhAnh.FindAsync(id);
            if (hinhAnh != null)
            {
