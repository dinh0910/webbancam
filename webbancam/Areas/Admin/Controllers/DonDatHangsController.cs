...
namespace webbancam.Areas.Admin.Controllers
{
    ...
    public class DonDatHangsController : Controller
    {
        ...
        public DonDatHangsController(webbancamContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.DonDatHang != null ? 
                          ...
                          Problem("Entity set 'webbancamContext.DonDatHang'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'webbancamContext.DonDatHang'  is null.");
            }
            var donDatHang = await _context.DonDatHang.FindAsync(id);
            if (donDatHang != null)
            {
